...
public class RandomSuggest {
    ...
    public void getRandomList(Context context, DbOpenHelper mdb, ArrayList<String> autoList, ArrayList<String> autoPathList, String tempCurrent) {
        ...
        //type_state={상의, 하의(한벌옷), 신발, 겉옷}
        int type_count=0;
//        String rCategory=getRandom(temp_compare);
//        checkSelectedCategory(type_state, type_compare, type_count, rCategory, temp_curr);
...
//            if(!type_compare[i].equals("")){
//                fname = mdb.selectCategory(type_compare[i], thick_compare);
//                if(fname!="") {
//                    autoList.add(fname);
//                    setAutoPathList(mdb, autoPathList, fname);
//                }
...
//        }
    ...
    private String getRandom(String[] compare) {
        String result="";
        Random r = new Random();
        int index = r.nextInt(compare.length-1);
